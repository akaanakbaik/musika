...
// ─── NEONDB / DATABASE ──────────────────────────────────────────────────────
// Database backend menggunakan NeonDB (PostgreSQL)
// Semua query database melalui backend API server, bukan langsung dari frontend
export const DATABASE_PROVIDER = "neondb";

// ─── CDN / AVATAR STORAGE ────────────────────────────────────────────────────
// Upload via backend API /api/upload
// Cara ganti: ubah endpoint upload di api.ts
