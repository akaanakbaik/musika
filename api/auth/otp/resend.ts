...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    await transport.sendMail({
      ...
      to: email,
      subject: `${code} — Your new Musika verification code`,
